...
class ExchangeRateDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "currencyCodeDest", "currencyCodeSrc", "exchangeRate", "exchangeRateUpdatedAt"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "exchangeRateUpdatedAt": obj.get("exchangeRateUpdatedAt")
        })
        return _obj
