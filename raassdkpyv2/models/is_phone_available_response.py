...
class IsPhoneAvailableResponse(BaseModel):
    ...
    has_pincode: StrictBool = Field(description="If the user already set a pincode for this phone, this field will be set to true.", alias="hasPincode")
    __properties: ClassVar[List[str]] = ["available", "verified", "hasPincode"]
