...
class RequestMoneyBase(BaseModel):
    """
    RequestMoneyBase
    """
    ...
    __properties = ["correlationId", "destinationPaymentMethod", "reason", "amount", "currency", "senderCurrency", "senderAmount", "recipientAmount", "recipientCurrency", "bonusAmount", "tenantId", "userTenantId", "application", "exchangeRate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RequestMoneyBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RequestMoneyBase:
        """Create an instance of RequestMoneyBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RequestMoneyBase.parse_obj(obj)

        _obj = RequestMoneyBase.parse_obj({
