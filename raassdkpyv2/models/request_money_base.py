...
class RequestMoneyBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["correlationId", "destinationPaymentMethod", "reason", "amount", "currency", "senderCurrency", "senderAmount", "recipientAmount", "recipientCurrency", "bonusAmount", "tenantId", "userTenantId", "application", "exchangeRate"]
