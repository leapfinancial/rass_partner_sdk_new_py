...
class LPOperationUserDetail(BaseModel):
    """
    LPOperationUserDetail
    """ # noqa: E501
    id: StrictStr
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LPOperationUserDetail from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of LPOperationUserDetail from a dict"""
        if obj is None:
            return None
