...
class PartnerPreQuoteRequest(BaseModel):
    """
    PartnerPreQuoteRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["DestinationPaymentMethod", "Amount"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PartnerPreQuoteRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PartnerPreQuoteRequest from a dict"""
        if obj is None:
            return None
