...
class UpdateContactRequestParams(BaseModel):
    """
    ...
    __properties = ["alias", "countryCode", "lastName", "firstName", "email", "phone"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateContactRequestParams:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateContactRequestParams:
        """Create an instance of UpdateContactRequestParams from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateContactRequestParams.parse_obj(obj)

        _obj = UpdateContactRequestParams.parse_obj({
            "alias": obj.get("alias"),
