...
class GetUserTokenParams(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetUserTokenParams:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetUserTokenParams:
        """Create an instance of GetUserTokenParams from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetUserTokenParams.parse_obj(obj)

        _obj = GetUserTokenParams.parse_obj({
