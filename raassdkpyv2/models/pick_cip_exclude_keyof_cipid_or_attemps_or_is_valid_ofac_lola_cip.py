...
class PickCIPExcludeKeyofCIPIdOrAttempsOrIsValidOFACLolaCIP(BaseModel):
    """
    This only applies for lola cip  # noqa: E501
    """
    update_at: datetime = Field(..., alias="updateAt")
    in_progress: StrictBool = Field(..., alias="inProgress")
    __properties = ["updateAt", "inProgress"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PickCIPExcludeKeyofCIPIdOrAttempsOrIsValidOFACLolaCIP:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PickCIPExcludeKeyofCIPIdOrAttempsOrIsValidOFACLolaCIP:
        """Create an instance of PickCIPExcludeKeyofCIPIdOrAttempsOrIsValidOFACLolaCIP from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PickCIPExcludeKeyofCIPIdOrAttempsOrIsValidOFACLolaCIP.parse_obj(obj)
