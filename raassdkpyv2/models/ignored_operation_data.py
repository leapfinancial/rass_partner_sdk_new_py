...
class IgnoredOperationData(BaseModel):
    ...
    reason: IgnoredOperationReason
    responsible_user_id: StrictStr = Field(alias="responsibleUserId")
    __properties: ClassVar[List[str]] = ["description", "date", "notifySupport", "reason", "responsibleUserId"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "date": obj.get("date"),
            "notifySupport": obj.get("notifySupport"),
