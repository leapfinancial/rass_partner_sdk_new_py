...
import raassdkpyv2.models
from raassdkpyv2 import rest
from raassdkpyv2.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(raassdkpyv2.models, klass)
