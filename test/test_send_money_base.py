...
from raassdkpyv2.models.send_money_base import SendMoneyBase  # noqa: E501

class TestSendMoneyBase(unittest.TestCase):
    """SendMoneyBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMoneyBase:
        """Test SendMoneyBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMoneyBase`
        """
        model = SendMoneyBase()  # noqa: E501
        if include_optional:
            return SendMoneyBase(
                correlation_id = '',
